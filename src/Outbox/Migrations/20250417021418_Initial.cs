    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "failed_outbox_messages",
                schema: "outbox",
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    transaction_id = table.Column<ulong>(type: "xid8", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_failed_outbox_messages", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    retry_after = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false, defaultValueSql: "now()")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "ix_failed_outbox_messages_created_at_retry_after_failed",
                schema: "outbox",
                table: "failed_outbox_messages",
                columns: new[] { "created_at", "retry_after", "failed" });

            migrationBuilder.CreateIndex(
                name: "ix_failed_outbox_messages_topic_partition_transaction_id_id",
                schema: "outbox",
                table: "failed_outbox_messages",
                columns: new[] { "topic", "partition", "transaction_id", "id" });

            migrationBuilder.CreateIndex(
                name: "ix_outbox_messages_created_at_retry_after_failed",
                schema: "outbox",
