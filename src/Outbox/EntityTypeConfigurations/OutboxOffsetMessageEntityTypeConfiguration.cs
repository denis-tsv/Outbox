...
public class OutboxOffsetMessageEntityTypeConfiguration : IEntityTypeConfiguration<OutboxOffsetMessage>
{
    public void Configure(EntityTypeBuilder<OutboxOffsetMessage> builder)
    {
